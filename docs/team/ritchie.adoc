...
*Code contributed*::
Functional Code: [https://github.com/CS2103AUG2017-W14-B2/main/blob/master/collated/main/ritchielq.md[Main file]] [https://github.com/CS2103AUG2017-W14-B2/main/blob/master/collated/test/ritchielq-reuse.md[Reused Code]] +
