...
== Introduction
Hello. My name is Bryan Koh, and I am a year 2 Computer Science student at National University of Singapore. This portfolio is designed to outline my software development project experiences to supplement my resume. If you are interested in contacting me for possible collaborations, do drop me an email at kohwxb@u.nus.edu. Thank you for taking some time off you read my works.
