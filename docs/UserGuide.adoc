...
*Figure 1.1* below shows you how the program is supposed to look like upon start up.
...
+
--
You can add a new contact using the command below. Figure 4.2.2.1 illustrates the
...
+
--
You can add a new contact without entering all the fields. Figure 4.4.2.2 illustrates
...
+
--
You cannot add a contact that already exists in Augustine. Figure 4.4.2.3 illustrates the
...
Figure 4.4.2.1 illustrates the details of the contact "bernice" before the command is executed and
Figure 4.4.2.2 illustrates the changes to the details of the contact "bernice" after the command
is executed.
...
* In Figure 4.4.2.1 Bernice has a "colleagues" tag and the command is typed without pressing enter.
...
* Figure 4.4.2.2 shows the result after the command is ran.
...
Figure 4.4.2.3 illustrates the details of the contact "bernice" before the command is executed and
Figure 4.4.2.4 illustrates the changes to the details of the contact "bernice" after the command
is executed.
...
* In Figure 2.4.2.4 Bernice phone number is 99272758, and her email is berniceyu@example.com
* The command will change the phone number to 87921929 and email to bernice@example.com
* Figure 2.4.2.4 shows the result after the command is ran.
...
The command below selects the 2nd person in address book. The result is shown in Figure 4.7.2.1.
...
Figure 4.9.2.1 illustrates the result after you execute the command below.
...
Figure 4.9.2.2 illustrates the result after you execute the command below.
...
Figure 4.9.2.3 illustrates illustrates the result after executing the command
below.
...
in one single command. Figure 4.9.2.4 illustrates the result after executing the command
below.
