...
find users by their names and then sort the resulting contact list by the tags (see Figure 13).
...
[caption="Figure 11. "]
.Before and after deleting the second person on the list
...
contact by its new index. The command below deletes the first person in the results displayed after
...
[caption="Figure 12. "]
.Before and after deleting the first person on the list
