...
== Development Operations [Updated in V1.4]
...
[INFO] Address Book depends on the http://wiki.fasterxml.com/JacksonHome[Jackson library] for XML parsing.
