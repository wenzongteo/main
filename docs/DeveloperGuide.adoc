...
. link:#testing[Run the tests] by right clicking and selecting the `Run All Tests` option on the test folder
under `src` folder in Intellij IDEA IDE.  *Ensure* that all test cases pass before commencing coding.
