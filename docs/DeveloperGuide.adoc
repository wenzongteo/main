...
Figure 3.4.1 below shows you the sequence diagram of how the `Add Command` works in Augustine.

[caption="Figure 3.4.1"]
.Sequence Diagram for the Add Command
image::addSequenceDiagram.png[width=""]
