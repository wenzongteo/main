...
[none]
* 3a. Destination file already exist.
+
[none]
** 3a1. AddressBook overwrites the existing file.
+
Use case ends.
...
[none]
* 3a. User enter person's particulars in different format than stored.
+
[none]
** 3a1. AddressBook parses person's particulars into a fixed format.
** 3a2. AddressBook adds the person.
+
Use case ends.

* 4a. User enter person's particulars with missing fields.
+
[none]
** 4a1. AddressBook treats missing fields as empty strings.
** 4a2. AddressBook parses person's particulars into a fixed format.
** 4a3. AddressBook adds the person.
