...
* 2a. User enter person's particulars with missing fields.
+
[none]
** 2a1. AddressBook treats missing fields as empty strings.
** 2a2. AddressBook parses person's particulars into a fixed format.
** 2a3. AddressBook adds the person.
+
Use case ends.
