...
. Model component may then be updated depending on the Command Type.
  ...
  [TIP]
  Model Component will be updated by Add, Delete, Clear, Edit, Find, List, Redo and Undo command.
...
_Figure X : Interactions Inside the Logic Component for the `delete 1` Command_
