...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("85355255").withPhoto("data/images/default.jpeg").withTags("friends")
    ...
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            ...
            .withPhoto("data/images/default.jpeg").withTags("owesMoney", "friends")
            .withBirthdate("12/11/1995").build();
    public static final ReadOnlyPerson CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withPhoto("data/images/default.jpeg").withEmailAddress("heinz@example.com")
            .withAddress("wall street").withBirthdate("12/10/1995").build();
    public static final ReadOnlyPerson DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withPhoto("data/images/default.jpeg").withEmailAddress("cornelia@example.com").withAddress("10th street")
    ...
    public static final ReadOnlyPerson ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822242")
            .withPhoto("data/images/default.jpeg").withEmailAddress("werner@example.com").withAddress("michegan ave")
    ...
    public static final ReadOnlyPerson FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94826427")
            .withPhoto("data/images/default.jpeg").withEmailAddress("lydia@example.com").withAddress("little tokyo")
    ...
    public static final ReadOnlyPerson GEORGE = new PersonBuilder().withName("George Best").withPhone("94822442")
            .withPhoto("data/images/default.jpeg").withEmailAddress("anna@example.com")
    ...
    public static final ReadOnlyPerson HOON = new PersonBuilder().withName("Hoon Meier").withPhone("84822424")
            ...
            .withPhoto("data/images/default.jpeg").withBirthdate("12/12/1995").build();
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84822131")
            .withPhoto("data/images/default.jpeg").withEmailAddress("hans@example.com")
    ...
    public static final ReadOnlyPerson ALICE_WITH_NUSMODULE = new PersonBuilder().withName("Alice Pauline")
            .withAddress("123, Jurong West Ave 6, #08-111").withEmailAddress("alice@example.com")
            .withNusModules("CS1231").withPhoto("data/images/default.jpeg").build();

    // Manually added - Person's details found in {@code CommandTestUtil}
    public static final ReadOnlyPerson AMY = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY)
            .withEmailAddress(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withPhoto("data/images/default.jpeg")
    ...
    public static final ReadOnlyPerson MISSINGNAME = new PersonBuilder().withPhone("84822131")
            ...
            .withPhoto("data/images/default.jpeg").build();
    public static final ReadOnlyPerson MISSINGPHONE = new PersonBuilder().withName("Ida Mueller")
            .withEmailAddress("hans@example.com").withPhoto("data/images/default.jpeg")
            .withAddress("chicago ave").build();
    public static final ReadOnlyPerson MISSINGADDRESS = new PersonBuilder().withName("Ida Mueller")
            .withPhone("84822131").withEmailAddress("hans@example.com").withPhoto("data/images/default.jpeg")
            .build();
