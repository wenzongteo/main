...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("85355255").withPhoto("alice@example.com.jpg").withTags("friends").withBirthdate("12/12/1995").build();
    public static final ReadOnlyPerson BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25").withEmail("johnd@example.com").withPhone("98765432")
            .withPhoto("johnd@example.com.jpg").withTags("owesMoney", "friends").withBirthdate("12/11/1995").build();
    public static final ReadOnlyPerson CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withPhoto("heinz@example.com.jpg").withEmail("heinz@example.com").withAddress("wall street")
            .withBirthdate("12/10/1995").build();
    public static final ReadOnlyPerson DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone("87652533")
            .withPhoto("cornelia@example.com.jpg").withEmail("cornelia@example.com").withAddress("10th street")
    ...
    public static final ReadOnlyPerson ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("94822242")
            .withPhoto("werner@example.com.jpg").withEmail("werner@example.com").withAddress("michegan ave")
    ...
    public static final ReadOnlyPerson FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("94826427")
            .withPhoto("lydia@example.com.jpeg").withEmail("lydia@example.com").withAddress("little tokyo")
    ...
    public static final ReadOnlyPerson GEORGE = new PersonBuilder().withName("George Best").withPhone("94822442")
            .withPhoto("anna@example.com.jpg").withEmail("anna@example.com").withAddress("4th street")
    ...
    public static final ReadOnlyPerson HOON = new PersonBuilder().withName("Hoon Meier").withPhone("84822424")
            .withEmail("stefan@example.com").withAddress("little india").withPhoto("stefan@example.com.jpg")
    ...
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84822131")
            .withPhoto("hans@example.com.jpg").withEmail("hans@example.com").withAddress("chicago ave")
            .withBirthdate("12/12/1995").build();
    ...
    public static final ReadOnlyPerson MISSINGNAME = new PersonBuilder().withPhone("84822131")
            .withEmail("hans@example.com").withAddress("chicago ave").withPhoto("hans@example.com.jpg").build();
    public static final ReadOnlyPerson MISSINGPHONE = new PersonBuilder().withName("Ida Mueller")
            .withEmail("hans@example.com").withPhoto("hans@example.com.jpg").withAddress("chicago ave").build();
    public static final ReadOnlyPerson MISSINGADDRESS = new PersonBuilder().withName("Ida Mueller")
            .withPhone("84822131").withEmail("hans@example.com").withPhoto("hans@example.com.jpg").build();
