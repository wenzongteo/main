...
public class TypicalPersons {
    ...
    public static final ReadOnlyPerson CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withPhoto("data/images/heinz@example.com.jpg").withEmailAddress("heinz@example.com").withAddress("wall street")
    ...
    public static final ReadOnlyPerson GEORGE = new PersonBuilder().withName("George Best").withPhone("94822442")
            .withPhoto("data/images/anna@example.com.jpg").withEmailAddress("anna@example.com").withAddress("4th street")
    ...
    public static final ReadOnlyPerson HOON = new PersonBuilder().withName("Hoon Meier").withPhone("84822424")
            .withEmailAddress("stefan@example.com").withAddress("little india").withPhoto("data/images/stefan@example.com.jpg")
            .withBirthdate("12/12/1995").build();
    public static final ReadOnlyPerson IDA = new PersonBuilder().withName("Ida Mueller").withPhone("84822131")
            .withPhoto("data/images/hans@example.com.jpg").withEmailAddress("hans@example.com").withAddress("chicago ave")
            .withBirthdate("12/12/1995").build();
    ...
    public static final ReadOnlyPerson MISSINGNAME = new PersonBuilder().withPhone("84822131")
            .withEmailAddress("hans@example.com").withAddress("chicago ave").withPhoto("data/images/hans@example.com.jpg")
            .build();
    public static final ReadOnlyPerson MISSINGPHONE = new PersonBuilder().withName("Ida Mueller")
            .withEmailAddress("hans@example.com").withPhoto("data/images/hans@example.com.jpg").withAddress("chicago ave")
            .build();
    public static final ReadOnlyPerson MISSINGADDRESS = new PersonBuilder().withName("Ida Mueller")
            .withPhone("84822131").withEmailAddress("hans@example.com").withPhoto("data/images/hans@example.com.jpg").build();
