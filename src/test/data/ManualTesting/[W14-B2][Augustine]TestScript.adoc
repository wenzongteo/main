...
*Expected*: Command succeed. The display message is +
...
--
*Command*: [red]`add n/tester e/tester@example.com` +
*Expected*: Command fail. The display message is +
...
*Expected*: Command succeed. Details of the person added will be shown.
--

'''
--
*Command*: [red]`add n/tester e/tester3@example.com b/12-12-1995` +
*Expected*: Command fail. Invalid date entry error will be shown.
--
...
'''
--
*Command*: [red]`add n/tester e/tester3@example.com b/12/13/1995` +
*Expected*: Command fail. Invalid date entry error will be shown.
--

'''
--
*Command*: [red]`add n/tester e/tester3@example.com b/12/3/1995` +
*Expected*: Command fail. Invalid date entry error will be shown.
--

'''
--
*Command*: [red]`add n/tester e/tester3@example.com b/2/12/1995` +
*Expected*: Command fail. Invalid date entry error will be shown.
--
...
'''
--
*Command*: [red]`add n/tester e/tester3@example.com b/29/12/1995` +
*Expected*: Command fail. Invalid date entry error will be shown.
--
